...
//  static public final int POINT_SPRITES = 52;
  ...
  static final char ALT       = KeyEvent.KEYCODE_ALT_LEFT;
  static final char SHIFT     = KeyEvent.KEYCODE_SHIFT_LEFT;
  static final char CONTROL   = KeyEvent.KEYCODE_CTRL_LEFT;
